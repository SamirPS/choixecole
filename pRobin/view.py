...
class ChoixEcole:
    ...
    def TEST(self):
        ...
        noteele=model.moyenneel(nom)

        self.notes_vars["maths"].set(noteele[1])
        self.notes_vars["si"].set(noteele[0])
        self.notes_vars["anglais"].set(noteele[5])
        self.notes_vars["informatique"].set(noteele[3])
        self.notes_vars["francais"].set(noteele[4])
        self.notes_vars["physique"].set(noteele[2])
